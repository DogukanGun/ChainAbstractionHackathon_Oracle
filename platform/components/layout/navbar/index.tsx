        ...
        <header className="relative z-50 w-full h-24">
            <div
                ...
                <a href="/" className="relative p-8 items-center inline-block h-full font-black leading-none">
                    <span className="ml-3 text-xl text-gray-800">NexArb<span className="text-pink-500">.</span></span>
                </a>
                ...
                <nav id="nav"
                    ...
                    <Link href="/sell"><p
                        className="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Sell Your Home</p></Link>
                    <Link href="/buy"><p
                        className="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Buy Your Home</p></Link>
                    <Link href="/verify"><p
                        className="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Verified Your Sale</p></Link>
                    <Link href="/ownership"><p
                        className="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Check Ownership</p></Link>
